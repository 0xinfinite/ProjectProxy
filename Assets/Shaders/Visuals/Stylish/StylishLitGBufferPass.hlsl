...
#include "../ShaderLibrary/StylizedLighting.hlsl"
...
FragmentOutput LitGBufferPassFragment(Varyings input)
{
    ...
    Light mainLight = GetMainLight(inputData.shadowCoord, inputData.positionWS, inputData.shadowMask, _ShadowCastOffset);
