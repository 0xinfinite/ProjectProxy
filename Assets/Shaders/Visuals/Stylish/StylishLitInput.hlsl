...
#include "../ShaderLibrary/StylizedSurfaceInput.hlsl"
#include "../ShaderLibrary/StylizedSurfaceData.hlsl"
...
#define _BaseMultiplier         UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _BaseMultiplier)
#define _GIMultiplier           UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _GIMultiplier)
