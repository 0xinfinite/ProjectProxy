...
Varyings UnlitPassVertex(Attributes input)
{
    ...
    //input.positionOS.xyz += input.normalOS.xyz * _Thickness * input.color.g;

    //VertexPositionInputs vertexInput = GetVertexPositionInputs(input.positionOS.xyz);
    VertexPositionNormalInputs vertexInput = GetVertexPositionNormalInputs(input.positionOS.xyz, input.normalOS, input.tangentOS, _Thickness * input.color.g);
